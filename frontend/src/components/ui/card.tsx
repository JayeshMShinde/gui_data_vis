...
>(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={cn(
      "rounded-xl border border-gray-200/60 dark:border-gray-700/60 bg-card/80 backdrop-blur-sm text-card-foreground shadow-soft hover:shadow-medium transition-all duration-300",
      className
    )}
    {...props}
  />
